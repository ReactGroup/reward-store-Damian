...
function LoginCard() {
    ...
    return (
      <div className="flex-container centered">
        <div className="card ">
          <div className="regla title"><p className="title-form">Login Form</p></div>
          <div className="regla">
          Username: Admite el valor "username".
          </div>
          <div className="regla">
         Password: Admite el valor "password" seguido de un punto. 
          ...
          <Link className="style"  to="/home">
            ...
            <Link className="style-em" to="/register"><em className="style-em"> Sing Up Now </em></Link>
             </p>
